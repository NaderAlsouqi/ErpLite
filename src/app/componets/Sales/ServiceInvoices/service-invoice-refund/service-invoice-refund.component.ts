...
@Component({
  selector: 'app-service-service-invoice-refund',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './service-invoice-refund.component.html',
  styleUrl: './service-invoice-refund.component.scss'
})
export class ServiceInvoiceRefundComponent implements OnInit {
 ...
 */
  ...
  generateRefundPDF(refund: RefundData): void {
    ...
    this.reportService.GenerateServiceTransferedRefundPDF(
