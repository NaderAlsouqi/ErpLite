      ...
      V: (t2, n2, o2, s2, e2) => {
        ...
        const _undoViewportArrange = (t3) => {
          if (u2) {
            ...
            const d2 = removeAttrClass(r2, j, W);
            setStyles(r2, a3);
            return [() => {
...
var createSizeObserver = (t2, n2, o2) => {
  ...
  return () => {
    ...
    if (f) {
      ...
      push(o3, concat([addClass(l2, ot), addEventListener(l2, "animationstart", t3)], n3));
    } else {
      return noop;
    }
  ...
  const createInteractiveScrollEvents = () => {
    ...
    return addEventListener(g2, "pointerdown", (o3) => {
      ...
      if (x2) {
        ...
        const O4 = e(getBoundingClientRect(f2)[r3]) / A(f2)[a2] || 1;
...
var createOverflowUpdateSegment = (t2, s2) => {
  ...
  return ({ It: n2, Zt: o2, _n: i2, Dt: a3 }, { fn: u3 }) => {
    ...
    const dt2 = u3 || b3 || y3 || it2 || rt2 || ot2 || et2 || j2 || q2 || W2;
...
OverlayScrollbarsDirective.ɵfac = function OverlayScrollbarsDirective_Factory(t2) {
  return new (t2 || OverlayScrollbarsDirective)(ɵɵdirectiveInject(NgZone));
};
...
OverlayScrollbarsComponent.ɵfac = function OverlayScrollbarsComponent_Factory(t2) {
  return new (t2 || OverlayScrollbarsComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef));
};
...
OverlayscrollbarsModule.ɵfac = function OverlayscrollbarsModule_Factory(t2) {
  return new (t2 || OverlayscrollbarsModule)();
};
